...
public class Magpie3
{
	...
	public String getResponse(String statement)
	{
		...
		else if (findKeyword(statement, "teacher") >=0 || findKeyword(statement, "Mauro") >= 0)
 		{ 
		...
		else if (findKeyword(statement, "grades") >= 0 
				|| findKeyword(statement, "shool") >= 0 
